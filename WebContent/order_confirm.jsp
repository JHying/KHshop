...
<html>
    ...
    <body>
        <%
            ...
            if (session.getAttribute("cartproduct") != null && session.getAttribute("orderdata") != null) {
                ...
                count = session.getAttribute("cartcount").toString();
                n = cart.size();
            } else {
        ...
        <div id="site-content">
            ...
            <main class="main-content">
                <div class="container">
                    <div class="page">
                        <h1 style="text-align:center">最後確認訂單資料</h1>
                        <h1 style="text-align:center">您訂購的內容</h1>
                        <table class="cart">
                            <thead>
                                <tr>
                        ...
                        <form action="SetOrder.do"  name="order_conform" method="POST">
                            <p  align="center">  收件人：<input type="text" name="guest_name" size="45%" value="<%=orderdata.get(1).toString()%>" readonly/></p>
                            <p  align="center">收件地址：<input type="text" name="guest_address" size="45%" value="<%=orderdata.get(2).toString()%>" readonly/></p>
                            <p  align="center">郵遞區號：<input type="text" name="guest_postalcode" size="45%" value="<%=orderdata.get(3).toString()%>" readonly/></p>
                            <p  align="center">聯絡電話：<input type="text" name="guest_phone" size="45%" value="<%=orderdata.get(4).toString()%>" readonly/></p>
                            <p  align="center">電子郵件：<input type="text" name="guest_email" size="45%" value="<%=orderdata.get(6).toString()%>" readonly/></p>
                            <p  align="center">付款方式：<select name="payment" style="width:32.5%" disabled>
                                    <option value="<%=orderdata.get(5).toString()%>"><%=orderdata.get(5).toString()%></option>
                                </select></p>
                            <p  align="center">匯款帳戶：<input type="text" name="guest_account" size="45%" value="<%=orderdata.get(7).toString()%>" readonly/></p>
                            <div class="cart-total">
                                <p class="total" bgcolor='red'><strong>總價</strong><span class="num">NT$<%=count%></span></p>
								<p align="right"><small>-- 運費160，滿4000免運 --</small></p>
								<p align="right">
                                    <a href="order.jsp" class="button muted">返回修改</a>    
                                    <button name="check" class="button">確認送單</button>              
                                </p>
                            </div> <!-- .cart-total -->
                        </form>
                    </div>
